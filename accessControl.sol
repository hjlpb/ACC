...
contract ACC {  
    ...
    function accessControl(uint256 resourceID, uint256[] memory clientAttributes, uint256 nonce, uint8 v, bytes32 r, bytes32 s) public {
        //policy should exist for the resourceID
    ...
    function sigVerify(address clientAddress, uint256[] memory clientAttributes, uint256 nonce, uint8 v, bytes32 r, bytes32 s) internal view returns(bool) {
    ...
    function policyCheck(uint256 resourceID, uint256[] memory clientAttributes) internal view returns(bool) {
